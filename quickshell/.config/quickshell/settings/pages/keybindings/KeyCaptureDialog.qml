...
Item {
    ...
    function _qtKeyToNiri(qtKey: int): string {
        ...
        const map = {
            ...
            [Qt.Keypad_Divide]:     "KP_DIVIDE",
            [Qt.Keypad_Multiply]:   "KP_MULTIPLY",
            [Qt.Keypad_Minus]:      "KP_SUBTRACT",
            [Qt.Keypad_Plus]:       "KP_ADD",
            [Qt.Keypad_Enter]:      "KP_ENTER",
            [Qt.Keypad_Decimal]:    "KP_DECIMAL",
            [Qt.Keypad_0]:          "KP_0",
            [Qt.Keypad_1]:          "KP_1",
            [Qt.Keypad_2]:          "KP_2",
            [Qt.Keypad_3]:          "KP_3",
            ...
            [Qt.Keypad_9]:          "KP_9",
            // Media / XF86
            [Qt.Key_AudioVolumeMute]:   "XF86_AUDIO_MUTE",
            [Qt.Key_AudioVolumeDown]:   "XF86_AUDIO_LOWER_VOLUME",
            [Qt.Key_AudioVolumeUp]:     "XF86_AUDIO_RAISE_VOLUME",
            [Qt.Key_MediaPlay]:         "XF86_AUDIO_PLAY",
            [Qt.Key_MediaStop]:         "XF86_AUDIO_STOP",
            [Qt.Key_MediaPause]:        "XF86_AUDIO_PAUSE",
            [Qt.Key_MediaPrevious]:     "XF86_AUDIO_PREV",
            [Qt.Key_MediaNext]:         "XF86_AUDIO_NEXT",
            [Qt.Key_MonBrightnessDown]: "XF86_MON_BRIGHTNESS_DOWN",
            [Qt.Key_MonBrightnessUp]:   "XF86_MON_BRIGHTNESS_UP",
            [Qt.Key_Search]:            "XF86_SEARCH",
            [Qt.Key_Calculator]:        "XF86_CALCULATOR",
        };
        return map[qtKey] || "";
    }
}
