...
QtObject {
    ...
    function surfaceOverlay(a: real): color {
        return isDark ? Qt.rgba(1, 1, 1, a) : Qt.rgba(0, 0, 0, a);
    }

    readonly property bool isDark: _scheme !== "light"
    ...
    readonly property color surfaceElev:    surfaceOverlay(isDark ? 0.08 : 0.06)
    readonly property color surfaceHover:   surfaceOverlay(0.14)
    readonly property color surfacePressed: surfaceOverlay(0.20)
    readonly property color border:         surfaceOverlay(0.10)
    ...
    readonly property color surfaceWindow:   isDark ? "#1a1611" : "#f5efe8"
    readonly property color surfaceTitleBar: isDark ? "#231d16" : "#ede5da"
    readonly property color surfaceSidebar:  isDark ? "#15110c" : "#faf6f0"
    readonly property color dividerColor:    isDark ? "#0e0a06" : "#d4cdc3"
    readonly property color textHeader:      isDark ? "#f5ede0" : "#2a2218"
    readonly property color textSubtitle:    isDark ? "#8a8175" : "#6b6258"
    readonly property color sliderTrack:     isDark ? "#1a1510" : "#e8e0d5"
